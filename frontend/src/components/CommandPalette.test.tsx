...
const services: ServiceStatus[] = [
  {
    ...
    custom: false, ext_monitored: true,
    internal_url: 'http://192.168.2.203', ext_url: 'https://vault.rxf-sys.de',
  ...
  },
  {
    ...
    custom: false, ext_monitored: true,
    internal_url: 'http://192.168.2.206', ext_url: 'https://cloud.rxf-sys.de',
